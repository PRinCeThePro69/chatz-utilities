...
module.exports = {
  ...
  let guilld = client.guilds.cache.get('930503731974385694');
    ...
    //  expires.setHours(expires.getHours() + duration)
      ...
      if(target.id === interaction.user.id) return interaction.followUp({content: 'You can\'t ban yourself.'})
   if(target.id === client.user.id) return interaction.followUp({content: 'You can\'t ban me.'})
